		...
		static void inspector() {
			if (g_Editor->m_InspectorMode == InspectorMode::ENTITY) {
				if (g_Editor->m_SelectedEntity.IsValid()) {
					...
					DrawComponent<Ease::Component::AnimatedSprite2D>(
						"AnimatedSprite2D", [](Ease::Component::AnimatedSprite2D &component) {
							ImGui::Text("AnimatedSprite2D");
						},
						entity);
					DrawComponent<Ease::Component::AudioStreamPlayer>(
						"AudioStreamPlayer", [](Ease::Component::AudioStreamPlayer &component) {
						...
						entity);
					DrawComponent<Ease::Component::Button>(
						"Button", [](Ease::Component::Button &component) {
							ImGui::InputText("Text", &component.Text());
							ImGui::Checkbox("Disabled", &component.Disabled());
						},
						entity);
					DrawComponent<Ease::Component::Camera2D>(
						"Camera2D", [](Ease::Component::Camera2D &component) {
							ImGui::Checkbox("Current", &component.Current());
							ImGui::DragFloat("Zoom", &component.Zoom(), 0.05f, 0.1f, 10.f);
						},
						entity);
					DrawComponent<Ease::Component::Group>(
						"Group", [](Ease::Component::Group &component) {
							ImGui::Text("Groups");
						...
						entity);
					DrawComponent<Ease::Component::NativeBehaviourClass>(
						"NativeBehaviourClass", [](Ease::Component::NativeBehaviourClass &component) {
							ImGui::InputText("Class Name", &component.ClassName());
						},
						entity);
					DrawComponent<Ease::Component::PhysicsBody2D>(
						"PhysicsBody2D", [](Ease::Component::PhysicsBody2D &component) {
							int bodyType = (int)component.BodyType();
							if ((int)Ease::PhysicsBodyType::STATIC != 0 || (int)Ease::PhysicsBodyType::DYNAMIC != 1 || (int)Ease::PhysicsBodyType::KINEMATIC != 2)
							...
							if (ImGui::CollapsingHeader("Colliders")) {
								...
								for (Ease::Collider2D &collider : component.Colliders()) {
									...
									if (ImGui::CollapsingHeader(std::to_string(i).c_str())) {
										...
										if ((int)Ease::ColliderShape2D::BOX != 0 || (int)Ease::ColliderShape2D::CIRCLE != 1)
						...
						entity);
					DrawComponent<Ease::Component::SpriteRenderer2D>(
						"SpriteRenderer2D", [](Ease::Component::SpriteRenderer2D &component) {
						...
						entity);
					DrawComponent<Ease::Component::TextRenderer2D>(
						"TextRenderer2D", [](Ease::Component::TextRenderer2D &component) {
							ImGui::InputText("Text", &component.Text());
						...
						entity);
					DrawComponent<Ease::Component::Transform2D>(
						"Transform2D", [](Ease::Component::Transform2D &component) {
						...
						entity);
					DrawComponent<Ease::Component::UITransform>(
						"UITransform", [](Ease::Component::UITransform &component) {
							ImGui::DragFloat2("Position", &component.Position().x);
							ImGui::DragFloat2("Scale", &component.Scale().x, 0.005f);
...
#define POPUP_ADDCOMPONENT(t)                              \
	{                                                      \
		if (!entity.HasComponent<Ease::Component::t>())    \
			if (ImGui::MenuItem(#t))                       \
				entity.AddComponent<Ease::Component::t>(); \
	}
...
#undef POPUP_ADDCOMPONENT
	...
	void OnImGuiRender() override {
		...
		ImGui::Begin("Editor", nullptr,
					 ImGuiWindowFlags_NoBringToFrontOnFocus | ImGuiWindowFlags_NoNavFocus | ImGuiWindowFlags_NoDocking | ImGuiWindowFlags_NoTitleBar | ImGuiWindowFlags_NoResize | ImGuiWindowFlags_NoMove | ImGuiWindowFlags_NoCollapse | ImGuiWindowFlags_MenuBar | ImGuiWindowFlags_NoBackground);
		ImGui::PopStyleVar(2);
